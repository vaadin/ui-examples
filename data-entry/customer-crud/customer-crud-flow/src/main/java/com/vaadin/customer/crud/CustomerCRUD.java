...
public class CustomerCRUD extends VerticalLayout {
    ...
    private ListDataProvider<Company> createDataProvider() {
        ...
        data.add(new Company("Alpha", "Julie Baroh", "julieb13@yahoo.com", "1600 Lind Ave SW", "Renton", "WA 98057", "Washington", "United States", "(067) 689-8833", "(214) 161-8881"));
        data.add(new Company("Arabian Nights", "Kaja Foglio", "kaja64@gmail.com", "SE 24th St", "Bellevue", "WA 98004", "Washington", "United States", "(322) 877-4256", "(214) 726-5305"));
        data.add(new Company("Time Spiral", "Dan Frazier", "frazier51@hotmail.com", "", "", "", "", "United States", "(364) 065-3803", "(972) 924-7669"));
        data.add(new Company("Fallen Empires", "Jesper Myrfors", "jesper45@yahoo.com", "", "", "", "", "Sweden", "(199) 360-6272", "(972) 197-0177"));
        data.add(new Company("Morningtide", "Brian Snøddy", "brians1@gmail.com", "", "", "", "", "United States", "(644) 936-3193", "(469) 740-6825"));
        data.add(new Company("Tempest", "Susan Van Camp", "susan19@gmail.com", "", "", "", "", "United States", "(723) 338-4034", "(214) 365-4444"));
        data.add(new Company("Legends", "Liz Danforth", "lizd@hotmail.com", "", "", "", "", "United States", "(644) 273-0079", "(972) 874-5649"));
        data.add(new Company("Antiquities", "Nene Thomas", "nenet84@yahoo.com", "", "Oklahoma City", "", "Oklahoma", "United States", "(771) 509-1730", "(214) 430-7750"));
        data.add(new Company("Alara Reborn", "Anthony S. Waters", "watersa@yahoo.com", "", "", "", "", "", "(687) 162-0128", "(469) 567-6514"));
        data.add(new Company("Unglued", "David A. Cherry", "dcherry@gmail.com", "", "Lawton", "", "Oklahoma", "United States", "(074) 366-4423", "(469) 358-9525"));
        data.add(new Company("Mirage", "John Avon", "john44@yahoo.com", "", "Cardiff", "", "South Wales", "United Kingdom", "(714) 000-0438", "(469) 468-3131"));
        data.add(new Company("Weatherlight", "Ian Miller", "miller74@gmail.com", "", "London", "", "England", "United Kingdom", "(435) 307-5309", "(214) 950-6083"));
        data.add(new Company("Visions", "Tony DiTerlizzi", "tony75@gmail.com", "", "Los Angeles", "", "California", "United States", "(793) 088-1786", "(469) 042-7450"));
        data.add(new Company("Weatherlight", "Mark Harrison", "harrison96@hotmail.com", "", "Birmingham", "", "West Midlands, England", "United Kingdom", "(097) 788-2612", "(214) 746-6340"));
        data.add(new Company("Mercadian Masques", "Jeff Laubenstein", "jeffl53@hotmail.com", "", "", "", "", "", "(906) 886-5063", "(214) 406-8397"));
        data.add(new Company("Portal", "Colin MacNeil", "colinmac@hotmail.com", "", "", "", "", "United Kingdom", "(430) 300-6257", "(469) 816-2081"));
        data.add(new Company("Tempest", "Alan Pollack", "alanp13@hotmail.com", "", "", "", "New Jersey", "United States", "(786) 663-4823", "(972) 582-5980"));
        data.add(new Company("Ravnica", "Mark A. Nelson", "marka@gmail.com", "", "", "", "", "United States", "(567) 679-7562", "(214) 751-3014"));
